...
public class NewBST {
    ...
    public static void main(String[] args){
        ...
        newBST.insert(2);
        newBST.insert(3);
        System.out.println(newBST.minimum());
        System.out.println(newBST.maximum());
        newBST.remove(3);
        newBST.insert(4);
        System.out.println(newBST.maximum());
        System.out.println(newBST.search(2).getKey());
        newBST.remove(1);
        newBST.remove(2);
        newBST.remove(3);
        newBST.remove(4);
...
//        System.out.println(newBST.getRoot().right.key);
        newBST.displayTree();
